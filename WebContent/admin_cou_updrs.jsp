...
<body bgcolor="#8dd8f8">
	...
	%>
	<div align="center">
		<font size="5" color="#000080" face="华文楷体"><b>修改课程信息：<br>
			<br></b></font>
	</div>
	<form name="formupdate" action="course_slt" method="post"
		onsubmit="return isValid(this);">
		<table width="650" border="1" cellspacing="0" cellpadding="0"
			align="center">
			<tr>
				<th height="25" colspan="2"><input type="hidden" name="action"
					value="update" /><font size="4">请在下表输入修改后课程信息</font></th>
			</tr>
			<%
				for (int j = 0; j < i; j++) {
