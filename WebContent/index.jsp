	...
	<table align="center">
		...
		<tr>
			<td><div align="center">
				...
				<h2 id="flyin"
					style="position: relative; left: -400; font-style: italic"
					style=&{ns4def}; align="center">
					<a style="text-decoration: none" href="login.jsp" target="_parent"><font
						face="幼圆" size="7" color="#0080ff"><i>欢迎使用学生成绩管理系统！</i></font> </a>
