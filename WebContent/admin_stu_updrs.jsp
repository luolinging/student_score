...
<body bgcolor="#8dd8f8">
	...
	%>
	<div align="center">
		<font size="5" color="#000080" face="华文楷体"><b>修改学生信息<br>
			<br>
			<br></b></font>
	</div>
	<form name="formupdate" action="student_slt" method="post"
		...
		<table width="650" border="1" cellspacing="0" cellpadding="0"
			...
			<tr>
				<th height="25" colspan="2"><input type="hidden" name="action"
					value="update" /><font size="4">请在下表输入修改后学生信息</font></th>
			</tr>
			<%
				for (int j = 0; j < i; j++) {
			...
			<tr>
				<td>学生专业：</td>
				<td><input type="text" name="smajor" value="<%=smajor%>" /></td>
			</tr>
			<tr>
				<th colspan="2" height="15"></th>
			</tr>
