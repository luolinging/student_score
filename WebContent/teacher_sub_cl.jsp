...
<body bgcolor="#8dd8f8">
	...
	<table border="1" cellspacing="0" cellpadding="0" align="center">
		...
		<tr align="center">
			...
			<td><%=cname%></td>
			<td><a
				href="teacher_sub_rs.jsp?cno=<%=cno%>&tid=<%=tid%>&con=subed&xls=yes"><img
					src="image/download1.png" /></a></td>
			<%
				if (con.equals("subing")) {
			%>
			<%
			...
			%>
			<td><a
				href="teacher_sub_rs.jsp?cno=<%=cno%>&tid=<%=tid%>&con=<%=con%>&xls=no">提交</a></td>
