...
<body bgcolor="#8dd8f8">
	<form name="formaddstu" action="student_slt" method="post"
		onsubmit="return isValid(this);">
		<div align="center">
			<font color="#0000a0" size="5" face="华文楷体"> <strong>添加学生信息<br>
				<br>
				<br></strong></font>
		</div>
		<table border="1" width="600" height="120" align="center"
			...
			<tr>
				<th colspan="2" height="25"><font size="4">请输入学生信息</font></th>
			</tr>
			<tr>
			...
			<tr>
				<td height="20">登录密码：</td>
				<td><input type="text" name="scode" /> <input type="hidden"
					name="action" value="new"></td>
			</tr>
			<tr>
				<th colspan="2" height="15"></th>
			</tr>
			<tr>
				<td height="20"><input type="reset" value="重&nbsp&nbsp置" /></td>
