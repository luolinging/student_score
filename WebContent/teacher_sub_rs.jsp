...
<body bgcolor="#8dd8f8">
	...
	%>
	<div align="center">
		<font size="4" color="#000080" face="华文楷体"><b><font
				size="5"><%=cou.getCname()%>选课学生如下：</font></b></font>
	</div>
	<form name="scoresub"
		action="sc_slt?sn=<%=i%>&tid=<%=tid%>&cno=<%=cno%>" method="post">
		<table border="1" cellspacing="0" cellpadding="0" align="center">

			<tr align="center">
				<td width="150">学号</td>
				<td width="150">姓名</td>
				<td width="150">课程学分</td>
				<td width="150">平时成绩</td>
				<td width="150">期末成绩</td>
			</tr>
			<%
				for (int j = 0; j < i; j++) {
			...
			<tr align="center">
				...
				%>
				<td><input type="text" name="pscore<%=j%>" value="<%=pscore%>"
					onchange="shuru(this.value )" /></td>
				<td><input type="text" name="lscore<%=j%>" value="<%=lscore%>"
					onchange="shuru(this.value )" /> <input type="hidden"
					name="sid<%=j%>" value="<%=sid%>" /></td>
				<%
					} else {
				%>
				<td><%=pscore%></td>
			...
			<tr>
				...
				<th colspan="3"><input type="submit" name="submit" value="暂时提交" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="submit" name="submit" value="最终提交" /><input
					type="hidden" name="action" value="scoresub" /></th>
			</tr>
			<tr>
				<td colspan="8"><div align="center">
						<strong><font size="4" color="#ff0000"> <font
								face="楷体">提示：暂时提交后成绩可修改，最终提交后不可修改！ </font></font></strong>
					</div></td>
			</tr>
			<%
				}
