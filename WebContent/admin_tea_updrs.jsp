...
<body bgcolor="#8dd8f8">
	...
	%>
	<div align="center">
		<font size="6" color="#000080" face="华文楷体"><b><font
				size="5">修改教师信息<br>
				<br>
				<br></font> </b></font>
	</div>
	<form name="formupdate" action="teacher_slt" method="post"
		onsubmit="return isValid(this);">
		<table width="650" border="1" cellspacing="0" cellpadding="0"
			align="center">
			<tr>
				<th height="25" colspan="2"><input type="hidden" name="action"
					value="update" />请在下表输入 修改后教师信息</th>
			</tr>
			<%
				for (int j = 0; j < i; j++) {
			...
			<tr>
				<td>教师工号：</td>
				<td><input type="text" name="tid" value="<%=rtid%>" readonly /></td>
			</tr>
			<tr>
			...
			<tr>
				<td>教师姓名：</td>
				<td><input type="text" name="tname" value="<%=rtname%>" /></td>
			</tr>
			<tr>
				<th colspan="2" height="15"></th>
			</tr>
			<tr>
				<td>教师密码：</td>
				<td><input type="text" name="tcode" value="<%=rtcode%>" /></td>
			</tr>
			<tr>
				<th colspan="2" height="15"></th>
			</tr>
