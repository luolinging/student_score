...
<body bgcolor="#8dd8f8">
	...
	<br />
	<div align="center">
		<strong><font size="5" face="楷体" color="#0000ff"><font
				color="#000080">导入成绩</font><br></font></strong>
	</div>
	<br />
	<form name="formaddcouxls" action="jxl_slt" method="post"
		...
		<table border="1" width="600" align="center" cellspacing="0"
			cellpadding="0">
			<tr height="25">
				<th colspan="2">从Excel导入学生成绩<input type="hidden" name="action"
					value="subsc"></th>
			</tr>
			<tr>
