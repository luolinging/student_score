...
<body bgcolor="#8dd8f8">
	...
	%>
	<div align="center">
		<font size="5" color="#0000a0" face="华文楷体"><strong>个人基本信息</strong></font>
	</div>
	<table border="1" align="center" cellspacing="0" cellpadding="0">
		...
		<tr align="center">
			<td width="80"><%=stu.getSid()%></td>
			<td><%=stu.getSname()%></td>
			<td><%=stu.getSmajor()%></td>
			<td><%=stu.getSclass()%></td>
			<td><%=stu.getTcredit()%></td>
			<td><%=Math.round(stu.getAcredit() * 100) / 100.0%></td>
			<td><%=Math.round(stu.getEgrade() * 100) / 100.0%></td>
			<td><%=stu.getClasspm()%></td>
			<td><%=stu.getMajorpm()%></td>
		</tr>
	</table>
	<br />
	<div align="center">
		<font size="5" color="#000080" face="华文楷体"><b>课程信息</b></font>
	</div>
