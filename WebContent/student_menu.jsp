		...
		<tr>
			<td>
				...
				<table width="1024" height="660" bgcolor="#ffffff" align="center"
					...
					<tr>
						<td>
							<table width="1016" height="652" bgcolor="#8dd8f8" align="center">
								<tr height="100">
									<td></td>
								</tr>
								<tr>
									<td>
										<form name="changecode"
											...
											<table align="center" border="1">
												...
												<tr>
													<td>原 密 码：</td>
													<td><input type="text" name="oldpa" /></td>
												</tr>
												<tr>
													<td>新 密 码：</td>
													<td><input type="text" name="newpa" /></td>
												</tr>
												<tr>
													<td>密码确认：</td>
													<td><input type="text" name="confpa" /> <input
