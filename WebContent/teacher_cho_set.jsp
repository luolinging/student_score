...
<body bgcolor="#8dd8f8">
	...
	<div align="center">
		<font color="#0000a0"><strong><font size="5"
				face="华文楷体"> 开设课程</font></strong></font><br>
		<br>
		<br>
	</div>
	<form name="formdelcou" action="tc_slt" method="post"
		onsubmit="return isValid(this);">
		<table border="1" width="600" align="center" cellspacing="0"
			cellpadding="0">
			<tr>
				<th height="25" colspan="2">请输入开设课程信息:</th>
			</tr>
			<tr>
				<td height="15"></td>
			</tr>
			<tr>
				<td height="25">课程序号：</td>
			...
			<tr>
				<td height="25">教学班号：</td>
				<td><input type="text" name="cteachno" /></td>
			</tr>
			<tr>
				<td height="15"></td>
			</tr>
			...
			<tr>
				<td height="25">课程容量：</td>
				<td><input type="text" name="cmax" /></td>
			</tr>
			<tr height="15">
