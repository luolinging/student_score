...
<body bgcolor="#8dd8f8">
	...
	<form name="lyb" action="msg_slt?id=<%=aid%>" method="post"
		...
		<table align="center" border="1">
			<tr align="center">
				<th colspan="2"><font face="华文楷体" color="#0000a0"><strong><font
							size="5">管理员回复</font> </strong> </font></th>
			</tr>
			<tr>
				<td align="right">留言：</td>
				<td align="left"><textarea name="content" id="content"
						cols="80" rows="15">管理员回复<%out.print(sname); %>:</textarea></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center"><input type="submit"
					name="submit" id="submit" value="提交回复"> &nbsp; <input
					type="reset" name="reset" id="reset" value="重新填写"></td>
			</tr>
		</table>
	</form>
	<tr height="100">
