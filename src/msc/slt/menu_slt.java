...
public class menu_slt extends HttpServlet {
	...
	public void doChangecode(HttpServletRequest request,
		...
		String oldpa = request.getParameter("oldpa");// 旧密码
		String newpa = request.getParameter("newpa");// 新密码
		String confpa = request.getParameter("confpa");// 确认密码
	...
	public void doQuit(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
