...
public class MscDAO {
	public Score CalAll(String sid) throws Exception {
		Score sco = new Score();
		String sql = "SELECT SUM(credit),SUM(scorejd) FROM sc WHERE sid='"
				+ sid + "';";
		Statement stmt = null;
	...
	public void AddScore(String sid, double tcredit, double tcreditjd)
			throws Exception {
		String sql = "UPDATE student set tcredit=" + tcredit + ",tcreditjd="
				+ tcreditjd + " WHERE sid='" + sid + "';";
		Statement stmt = null;
	...
	public void AddOCredit(String sid, double ocredit) throws Exception {
		String sql = "UPDATE student set ocredit=" + ocredit + " WHERE sid='"
				+ sid + "';";
		Statement stmt = null;
		DataBaseConnection dbc = null;
		dbc = new DataBaseConnection();
	...
	public void AddEgrade(String sid, double egrade, double acredit)
			throws Exception {
		String sql = "UPDATE student set egrade=" + egrade + ",acredit="
				+ acredit + " WHERE sid='" + sid + "';";
		Statement stmt = null;
		DataBaseConnection dbc = null;
		dbc = new DataBaseConnection();
		try {
	...
	public void AddRank(String sid, int classpm, int majorpm, int con)
			throws Exception {
		String sql = null;
		if (con == 1) {
			sql = "UPDATE student set majorpm=" + majorpm + " WHERE sid='"
					+ sid + "';";
		} else {
			sql = "UPDATE student set classpm=" + classpm + " WHERE sid='"
					+ sid + "';";
		}
		Statement stmt = null;
		DataBaseConnection dbc = null;
